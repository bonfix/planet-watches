...
import { getStorageItem, setStorageItem, StorageItem } from '@core/utils';
...
export class ThemeService implements OnDestroy {
  ...
  get storedTheme(): ThemeList {
    return getStorageItem(StorageItem.Theme) as ThemeList;
  }

  set storedTheme(theme: ThemeList) {
    setStorageItem(StorageItem.Theme, theme);
  }
